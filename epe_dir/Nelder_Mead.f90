...
!     HSTAR = FUNCTION VALUE AT PSTAR.
  ...
  IF (iprint > 0) THEN
    ...
    IF (MOD(neval,iprint) == 0) WRITE (11,5100) neval, hstar, pstar
  END IF
...
!     HSTST = FUNCTION VALUE AT PSTST.
  ...
  IF (hstar < hmin) THEN
    ...
    IF (iprint > 0) THEN
      ...
      IF (MOD(neval,iprint) == 0) WRITE (11,5100) neval, hstst, pstst
    END IF
  ...
  DO i = 1, np1
    IF (i /= imin) THEN
      ...
      IF (iprint > 0) THEN
        ...
        IF (MOD(neval,iprint) == 0) WRITE (11,5100) neval, h(i), p
      END IF
    END IF
  END DO
...
!     FIND THE CENTROID OF THE CURRENT SIMPLEX AND THE FUNCTION VALUE THERE.
  ...
  IF (iprint > 0) THEN
    ...
    IF (MOD(neval,iprint) == 0) WRITE (11,5100) neval, func, p
  END IF
...
DO i = 1, np1
  DO
    ...
    IF (test < simp) THEN
      ...
      IF (iprint >= 0) WRITE (11,5100) neval, hmin, pstst
    ELSE
      EXIT
    END IF
  END DO
