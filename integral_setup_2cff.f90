...
!=====================================================================
subroutine  integral_setup_2cff()
!----------------------------------------------------------------
!
!  Purpose: Contains calls to setup-routines to be executed
!           at beginning of 2 Center fitfunction integral 
!           calculation.
!
!
!  Subroutine called by: integral_main_2cff, main_slave
!
!
!  Author: TB
!  Date: 5/96
...
if (output_int_detailedprogress) call write_to_output_units( &
     "integral_setup_2cff:  end")


end subroutine integral_setup_2cff
