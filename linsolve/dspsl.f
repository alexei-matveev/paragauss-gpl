      ...
      use type_module
      IMPLICIT   none
      integer(kind=i4_kind)  n,kpvt(*)
      real(kind=r8_kind) ap(*),b(*)
c
...
c
      real(kind=r8_kind) ak,akm1,bk,bkm1,ddot,denom,temp
      integer(kind=i4_kind) ik,ikm1,ikp1,k,kk,km1k,km1km1,kp
c
