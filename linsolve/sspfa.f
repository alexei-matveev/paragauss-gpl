      ...
      use type_module
      IMPLICIT   none
      integer(kind=i4_kind) n,kpvt(*),info
      real(kind=r8_kind) ap(*)
c
...
c
      real(kind=r8_kind) ak,akm1,bk,bkm1,denom,mulk,mulkm1,t
      real(kind=r8_kind) absakk,alpha,colmax,rowmax
      integer(kind=i4_kind) isamax,ij,ijj,ik,ikm1,im,imax,imaxp1,
     &                      imim,imj,imk
      integer(kind=i4_kind) j,jj,jk,jkm1,jmax,jmim,k,kk,km1,km1k,
     &                      km1km1,km2,kstep
      logical swap
c
c
...
c     alpha is used in choosing pivot block size.
      alpha = (1.0_r8_kind + sqrt(17.0_r8_kind))/8.0_r8_kind
c
      info = 0
c
...
c
   ...
   80       continue
   90    continue
         if (max(absakk,colmax) .ne. 0.0_r8_kind) go to 100
c
