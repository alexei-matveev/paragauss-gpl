...
ifeq ($(serial),1)
  ...
  FC = /gpfs/CLUSTERUSERS/chemicct/local/bin/mpif90 
endif
F77 = $(FC)
...
extraflags   =
staticflags  = -static 
#LINKFLAGS    = -L/gpfs/CLUSTERUSERS/chemicct/local/lib64/ /gpfs/CLUSTERUSERS/chemicct/local/lib64/libgfortran.so
LINKFLAGS    = -L/gpfs/CLUSTERUSERS/chemicct/local/lib64/ -static-libgfortran 
...
FPP = $(CPP)
FPPOPTIONS += $(CPPOPTIONS) -D_$(MACH) -D_SFU_KRSK
#
...
LAPACKLIBS =	-L/gpfs/CLUSTERUSERS/chemicct/local/lib64/ -llapack -lblas
SYSTEMLIBS =
