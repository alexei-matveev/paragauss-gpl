...
FPP = $(CPP)
FPPOPTIONS += $(CPPOPTIONS) -D_$(MACH) -D_ITANIUM_NSK
#
...
MPILIBS =       -lmpich
LAPACKLIBS =    -L$LIBRARY_PATH -I$FPATH -lmkl_lapack -lmkl_ipf \
		-lguide -Bdynamic -lpthread -lmtl_common -lm
#		-lguide -Bdynamic -lpthread -lmtl_common -lm
BLASLIBS =	
